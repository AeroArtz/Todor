                    ...
                    <div className="lg:col-start-2">
                        ...
                        {order._isPaid ? (
                            <p className="mt-2 text-base text-muted-foreground">
                                Your order was processed and you will receive 
                                it shortly. We&apos;ve sent your receipt and order details to{' '}
                            ...
                            <p className="mt-2 text-base text-muted-foreground">
                                ...
                                processing it. So hang titght and we&apos;ll send you confirmation
                                very soon!
                            </p>
                        )}
